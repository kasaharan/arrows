package
{
	...
	public class ReleaseConnect extends Connect
	{
		...
		{			
			...
			vars.dummy = dummy;
			vars.hash = Hash.getHash(vars.dummy + vars.sendtime + escapeMultiByte(vars.name) + vars.pwd + escapeMultiByte(vars.id));

			send(vars, "ar_release8.php");
		}
